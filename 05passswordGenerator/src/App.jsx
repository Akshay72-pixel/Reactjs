...
function App() {
  ...
  const generatePassword = useCallback(()=>{
    let pass = "";
    let str = "ABCDEFGHSPLMMKGBJJLLOPMBDUHksbhbskhdhjdhjl"
  ...
  return (
    ...
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500'>
      <h1 className='text-white text-center my-3'>Password Generate</h1>
      <div className='flex shadow rounded-lg overflow-hidden mb-4'>
        <input type="text" value={password} className='outline-none w-full py-1 px-3 bg-yellow-50 '
